...
this.command('Halo', ['halo disini StaycoolBot','kamu siapa?']);
this.command('Hi', ['hi disini StaycoolBot','kamu siapa?']);

this.command('staycoolbot', ['Apa kak? ada yg bisa dibantu?','Ketik /help untuk bantuan']);
...
this.command('bot', ['apa kak manggil2 aku?']);
        ...
        this.command(`Invite Juga StaycoolBot II Kesini ^_^`,this.bot2.bind(this));
